...
const eventLabels: Record<string, { label: string; description: string }> = {
  companyRegistration: {
    ...
    description: 'When a new company registers on the platform'
  },
  subscriptionExpiring: {
    label: 'Subscription Expiring',
    description: 'When a company subscription is about to expire'
  },
  subscriptionExpired: {
    label: 'Subscription Expired',
    description: 'When a company subscription has expired'
  },
  subscriptionRenewed: {
    label: 'Subscription Renewed',
    description: 'When a company renews their subscription'
  },
  paymentReceived: {
    label: 'Payment Received',
    description: 'When a payment is received from a company'
  },
  paymentFailed: {
    label: 'Payment Failed',
    description: 'When a payment from a company fails'
  },
  systemAlert: {
    label: 'System Alerts',
    description: 'Important system-wide alerts and notifications'
  },
  securityAlert: {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Manage how you receive notifications about platform events
        </p>
      </div>
